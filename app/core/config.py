...
class Settings(BaseSettings):
    ...
    cors_allow_methods: list = Field(["GET", "POST", "PUT", "DELETE", "OPTIONS"], env="CORS_ALLOW_METHODS")
    cors_allow_headers: list = Field(["*"], env="CORS_ALLOW_HEADERS")
    cors_expose_headers: list = Field([], env="CORS_EXPOSE_HEADERS")
    cors_max_age: int = Field(600, env="CORS_MAX_AGE")
    cors_allow_origin_regex: Optional[str] = Field(None, env="CORS_ALLOW_ORIGIN_REGEX")
